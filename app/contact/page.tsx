        ...
        <div className="grid gap-0 max-w-2xl">
          {site.socials.map((s) => (
            ...
            >
              ...
              <span className="w-7 h-7 shrink-0 flex items-center justify-center text-accent transition-transform duration-200 ease-out group-hover:scale-110 group-hover:-rotate-6">
